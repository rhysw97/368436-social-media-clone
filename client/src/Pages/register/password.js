...
export default function Password(props) {
    ...
    //regexs to use check the password is valid
    const regexs = {
        eightOrMore: /.{8,}/,
        oneCap: /[A-Z]/,
        oneLower: /[a-z]/,
    ...
    //object to hold the messages to show to the user
        ...
        Object.keys(isValid).forEach(key => {
            ...
            if(!isValid[key]) {
                ...
                if(!passwordRequirements.includes(passwordMessages[key])) {
                    //if its passwordRequirements doesn't already contain the message then add it into state
